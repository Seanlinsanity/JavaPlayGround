...
public class DeleteNodeInBST {
    ...
    TreeNode deleteNodeRecursion(TreeNode node, int key) {
        ...
        if (val > key) {
            ...
            TreeNode rightSmallestNode = node.right;
            while (rightSmallestNode.left != null) {
                parent = rightSmallestNode;
                rightSmallestNode = rightSmallestNode.left;
            }

            node.val = rightSmallestNode.val;
            if (parent == node) {
                parent.right = rightSmallestNode.right;
            } else {
                parent.left = rightSmallestNode.right;
            }
        }
